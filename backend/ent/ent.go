...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			lineclassification.Table:         lineclassification.ValidColumn,
			outboxentry.Table:                outboxentry.ValidColumn,
			ruleversion.Table:                ruleversion.ValidColumn,
			spvconnection.Table:              spvconnection.ValidColumn,
			spvoauthstate.Table:              spvoauthstate.ValidColumn,
			spvsourcedocument.Table:          spvsourcedocument.ValidColumn,
			sagaexportattempt.Table:          sagaexportattempt.ValidColumn,
			validationtask.Table:             validationtask.ValidColumn,
		})
	})
