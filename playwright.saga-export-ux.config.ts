...
export default defineConfig({
  testDir: './e2e', testMatch: 'saga-export-ux.spec.ts', fullyParallel: false, workers: 1, reporter: 'list',
  use: { baseURL: 'http://127.0.0.1:4180', trace: 'on-first-retry' },
  projects: [{ name: 'chromium', use: { ...devices['Desktop Chrome'] } }],
  webServer: [
    { command: './scripts/start-saga-export-ux-e2e.sh', url: 'http://127.0.0.1:8080/readyz', reuseExistingServer: false, timeout: 120_000 },
