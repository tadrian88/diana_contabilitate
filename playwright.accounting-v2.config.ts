...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'VITE_BACKEND_READS_ENABLED=true VITE_API_PROXY_TARGET=http://127.0.0.1:8080 npm run dev -- --host 127.0.0.1 --port 4184', url: 'http://127.0.0.1:4184', reuseExistingServer: true, timeout: 120_000 },
  ],
})
