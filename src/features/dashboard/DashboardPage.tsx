...
function DashboardError() { return <div className="card p-12 text-center"><TriangleAlert className="mx-auto size-8 text-[var(--danger)]" /><h2 className="mt-3 font-bold">Dashboard-ul nu a putut fi încărcat</h2><p className="mt-1 text-sm text-[var(--text-secondary)]">Serviciul de date nu este disponibil. Verifică starea API-ului.</p></div> }
